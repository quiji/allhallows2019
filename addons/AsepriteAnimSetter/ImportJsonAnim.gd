...
func selectSprite(sprite):
	...
	if sprite.texture != null:
		...
		if sprite.has_meta("framesize_x"):
			#framesize.x = sprite.get_meta("framesize_x")
			$MarginContainer/VBoxContainer/OptionsPanel/ScrollContainer/MarginContainer/Grid/Framesize/FramesizeX.value = sprite.get_meta("framesize_x")

		if sprite.has_meta("framesize_y"):
			#framesize.y = sprite.get_meta("framesize_y")
			$MarginContainer/VBoxContainer/OptionsPanel/ScrollContainer/MarginContainer/Grid/Framesize/FramesizeY.value = sprite.get_meta("framesize_y")
		
		if sprite.has_meta("anim_player_name"):
			animPlayerName = sprite.get_meta("anim_player_name")
			$MarginContainer/VBoxContainer/OptionsPanel/ScrollContainer/MarginContainer/Grid/AnimPlayerName.text = sprite.get_meta("anim_player_name")
...
func on_FramesizeX_value_changed(value):
	framesize.x = value
	if sprite:
		sprite.set_meta("framesize_x", value)

func on_FramesizeY_value_changed(value):
	framesize.y = value
	if sprite:
		sprite.set_meta("framesize_y", value)
...
func on_AnimPlayerName_text_changed(new_text):
	...
	if sprite:
		sprite.set_meta("anim_player_name", new_text)
...
"""
func _process(delta):
	if sprite and lastTexture != sprite.texture:
		selectSprite(sprite)
"""